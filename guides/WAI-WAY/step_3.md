...
|---------|--------------|
| FORGER adds features | Say: "Remove [feature]. Only build what's in the spec." |
| FORGER skips phases | Say: "Complete Phase N first." |
| Wrong imports | Say: "Use @donotdev/[package]" |
| Type errors | Say: "Fix error: [message]" |
| Context lost | Say: "We completed 1-N. Continue from Phase N+1." |
